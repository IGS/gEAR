...
from resources.track_hub import TrackHubValidate, TrackHubCopy # noqa: E402
...
api.add_resource(TrackHubValidate, '/import/trackhub/validate')
api.add_resource(TrackHubCopy, '/import/trackhub/copy')
