...
"""
- Receives dataset upload data from gosling_panel_designer.js.
...
def main():
    ...
    dataset_config = form.getvalue("gosling_config")
    ...
    if user is None:
        ...
        cursor.execute(dataset_display_sql, (dataset_uid, user.id, "Gosling curation", "gosling", dataset_config,))
