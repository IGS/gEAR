...
def main():
    ...
    if for_page is None:
        ...
        public_collection.get_public(has_h5ad=1, types=['microarray', 'bulk-rnaseq', 'singlecell-h5ad', 'single-cell-rnaseq', 'violin-standard'])
    ...
    if user is not None:
        if for_page is None:
            ...
            user_collection = user.datasets(has_h5ad=1, types=['microarray', 'bulk-rnaseq', 'singlecell-h5ad', 'single-cell-rnaseq', 'violin-standard'])
