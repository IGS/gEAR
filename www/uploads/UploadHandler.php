...
class UploadHandler
{
    ...
    function get_config_bytes($val) {
        ...
        // Convert number to int -> https://stackoverflow.com/a/57937987
    ...
    protected function get_unique_filename($file_path, $name, $size, $type, $error,
        ...
        // Handle unknown content ranges
        // SAdkins - Unsure if filename should be upcounted or not but I want to err on the side of caution
